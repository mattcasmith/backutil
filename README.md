...
```diff
-Backutil is a learning/hobby project and at least some aspects of its code may not follow best practices.
-If you choose to use it, you do so at your own risk. Make sure you take a manual backup of your files before
-trying it out, and don't rely on it to back up your production servers.
```
